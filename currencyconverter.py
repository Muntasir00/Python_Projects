...
class CurrencyConverter: #create class
    def __init__(self): 
        ...
        Label(window,font="Helvica 12 bold",bg="yellow",text="Conversion Rate").grid(row=2, column=1,sticky=W)
        Label(window,font="Helvica 12 bold",bg="yellow",text="Converted Amount").grid(row=3, column=1,sticky=W)
    ...
    #Function to do the conversion. Store inputs and performs conversions
